...
async def Line_Login(data: LineAccessToken):
    try:
        ...
        # ดึง line user id จากตัวแปร UserProfile มาเก็บไว้ที่ตัวแปร UUID_line
        ...
        return {"error": "HTTPError", "status": requests.status_codes}
    except IndexError:
        return {"error": "IndexError", "status": "Error"}